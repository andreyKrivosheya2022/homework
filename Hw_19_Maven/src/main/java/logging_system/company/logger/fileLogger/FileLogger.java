...
import logging_system.company.exception.FileMaxSizeReachedException;
...
public class FileLogger extends Logger {
    ...
    private void deleteDirectory() {
        for (File deleteFile : Objects.requireNonNull(new File("src/main/resources/text").listFiles())) {
    ...
    private void createFile() throws Exception {
        ...
        file = new File("src/main/resources/text/" + pathToFile);
        file.createNewFile();
